  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h2 className="text-xl font-bold text-[var(--color-foreground)] tracking-tight">My Photography Proposals</h2>
        <Link to="/gigs" className="dc-btn-primary px-5 py-2 text-sm">Find Photography Work</Link>
      </div>
      ...
      <div className="dc-card p-5 space-y-3" style={{ borderRadius: 20 }}>
        {bids.length === 0 ? (
          <div className="py-8 text-center">
            ...
            <p className="text-sm text-[var(--color-muted-foreground)] mt-2">You haven't bid on any photography gigs yet.</p>
          </div>
        ) : bids.map(bid => (
